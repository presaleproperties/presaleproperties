...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { data: project, error: projErr } = await supabase
      ...
      .select("name, city, neighborhood, developer_name, featured_image, gallery_images, hero_image, price_range, starting_price, deposit_structure, deposit_percent, completion_year, completion_month, slug, brochure_files, floorplan_files, pricing_sheets")
      .eq("id", pid)
      .single();
