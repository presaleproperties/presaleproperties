      ...
      <div className="container relative px-4">
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <h1 className="font-bold tracking-tight mb-4 sm:mb-6 leading-[1.1]">
              <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-background">
                New Construction.
              </span>
              <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-primary">
                Expert Help.
              </span>
              <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-background">
                No Extra Cost.
