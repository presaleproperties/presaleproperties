import { TrendingUp, Home, BadgeDollarSign, Users } from "lucide-react";

const impactStats = [
  {
    icon: BadgeDollarSign,
    stat: "$20K–$30K+",
    label: "Average Incentives Negotiated",
  },
  {
    icon: Home,
    stat: "400+",
    label: "Presale Homes Sold",
  },
  {
    icon: Users,
    stat: "$1,500",
  ...
  },
  {
    icon: TrendingUp,
    stat: "5+ Years",
    label: "Dedicated Presale Experience",
  },
];
      ...
      <div className="container px-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {impactStats.map((item) => (
            ...
            >
              ...
              <p className="text-2xl md:text-3xl font-bold text-foreground mb-1">{item.stat}</p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {caseStudies.map((study) => (
            <div
              key={study.title}
              className="bg-gradient-to-br from-muted/50 to-muted/20 rounded-2xl p-8 border"
            >
