...
export function ProjectMobileCTA({ 
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-background/98 backdrop-blur-xl border-t border-border shadow-[0_-4px_20px_rgba(0,0,0,0.15)] hide-on-keyboard">
