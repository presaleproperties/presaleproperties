        ...
        <div className="max-w-lg">
          ...
          <div className="relative rounded-2xl overflow-hidden border border-border/50 bg-background shadow-lg">
            ...
            <div className="relative p-6 sm:p-8">
              ...
              <div className="flex items-start gap-5 mb-6">
                <div className="relative shrink-0">
                  <img
                    src={agent.photo}
                    alt={agent.fullName}
                    className="w-24 h-24 rounded-2xl object-cover object-top border-2 border-primary/30 shadow-md"
                  />
              ...
              {/* Brokerage note */}
              <div className="flex items-start gap-3 p-4 rounded-xl bg-muted/30 border border-border/40 mt-6">
