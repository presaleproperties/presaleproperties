  ...
  <style>
    ...
    *{box-sizing:border-box;}
    ...
    @media only screen and (max-width:620px){
      ...
      .fp-cell{display:block!important;width:100%!important;padding:8px 4px!important;}
...
<table width="600" cellpadding="0" cellspacing="0" border="0" class="email-container" style="max-width:600px;width:100%;background:#ffffff;border:1px solid #e0dbd3;">
  ...
  <tr>
    <td style="padding:0;line-height:0;font-size:0;">
      <img src="${data.heroImage}" alt="${data.projectName}" width="600"
  ...
  <tr>
    <td class="mobile-pad" style="padding:32px 36px 24px;">
      ${data.headline ? `
      <p style="margin:0 0 16px 0;font-family:${DISPLAY_FONT};font-size:26px;font-weight:800;color:#0d1f18;line-height:1.2;letter-spacing:-0.5px;">${data.headline}</p>
