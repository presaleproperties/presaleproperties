...
export function PresaleProjectCard({
  ...
  return (
    <Link to={projectUrl}>
      <Card className="group overflow-hidden border-border/60 bg-card shadow-card hover:shadow-premium hover:border-primary/30 hover:-translate-y-2 transition-all duration-300 ease-out h-full rounded-2xl">
        <div
          className={cn(
