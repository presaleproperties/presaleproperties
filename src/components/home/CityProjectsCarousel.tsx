...
export function CityProjectsCarousel({ city, title, subtitle, excludeSlug }: CityProjectsCarouselProps) {
  ...
  return (
    <div className="space-y-4 md:space-y-5">
      ...
      {/* Scrollable cards — kept inside the parent panel padding for unified rhythm */}
      <div
        ref={scrollRef}
        className="flex gap-2.5 sm:gap-3 md:gap-4 overflow-x-auto scrollbar-hide pb-2 scroll-snap-x scroll-snap-mandatory"
      >
