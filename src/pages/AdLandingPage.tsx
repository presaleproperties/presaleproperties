  ...
  return <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative -mx-0">
          ...
          {/* Compact Above-the-Fold: Selling Points + CTA + Incentive Teaser */}
          <div className="px-4 pt-4 pb-3 space-y-4">
            {/* Selling Points - Tighter spacing */}
            <div className="flex flex-wrap justify-center gap-1.5">
              {getSellingPoints().slice(0, 3).map((point, index) => (
                <div 
                  key={index} 
                  className="inline-flex items-center gap-1.5 bg-primary/10 rounded-full px-3 py-1.5 border border-primary/20"
                >
                  <CheckCircle className="h-3.5 w-3.5 text-primary flex-shrink-0" />
                  <span className="text-foreground text-xs font-semibold">{point}</span>
                </div>
              ))}
            </div>
            ...
            {/* Inline Incentive Teaser */}
            <div className="flex items-center justify-center gap-3 text-sm">
              <span className="flex items-center gap-1 text-primary font-semibold">
                🔥 {getIncentiveSavings()} Savings
              </span>
              <span className="text-muted-foreground">•</span>
              <span className="flex items-center gap-1 text-foreground font-medium">
                {getIncentiveDeposit()} Deposit
              </span>
              <span className="text-muted-foreground">•</span>
              <span className="flex items-center gap-1 text-foreground font-medium">
                {getIncentiveBonus()}
        ...
        <section className="px-5 py-5 bg-muted/30">
          <h2 className="text-base font-bold text-foreground text-center mb-3">
            Own For Just
          </h2>
