  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", height: 330, overflow: "hidden", background: "#111" }}>
        ...
        {/* Top-right VIP badge */}
        <div style={{ position: "absolute", top: 20, right: 18, background: C.gold, borderRadius: 20, padding: "4px 12px", fontSize: 7, fontWeight: 700, color: "#111", letterSpacing: "0.12em" }}>
          {data.vipBadge}
        </div>
