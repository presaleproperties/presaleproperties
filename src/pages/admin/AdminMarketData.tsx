...
import { Plus, Pencil, Trash2, ExternalLink, TrendingUp, RefreshCw } from "lucide-react";
...
const EMPTY_FORM: Omit<MarketData, 'id' | 'updated_at'> = {
  ...
  avg_rent_1br: 1900,
  avg_rent_2br: 2500,
  source_name: "REBGV MLS HPI",
  source_url: "https://www.rebgv.org/market-watch",
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">
              Manage investment metrics used in project analysis. Update quarterly from official sources.
            </p>
          </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        placeholder="https://www.rebgv.org/market-watch"
                      />
                    </div>
                    <div>
        ...
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardDescription>Update quarterly from these official sources</CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    {marketData?.length === 0 && (
                      <TableRow>
                        <TableCell colSpan={9} className="text-center text-muted-foreground py-8">
                          No market data yet. Add a city to get started.
                        </TableCell>
                      </TableRow>
                    )}
                  </TableBody>
