          ...
          <div className="container max-w-4xl">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="p-6 rounded-xl border-2 border-primary/20 bg-primary/5">
                ...
                <h3 className="font-bold mb-2">Agent-to-Agent Deals</h3>
                <p className="text-sm text-muted-foreground">
                  Connect directly with selling agents. No middlemen. Quality over quantity.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container max-w-3xl">
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              {[
                ...
                { step: "3", title: "Get to Work", desc: "Download, compare, book tours" },
              ].map((item) => (
