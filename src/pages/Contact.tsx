...
export default function Contact() {
  ...
  const completeLead = async (phone: string, data: ContactFormData) => {
        ...
        <div className="min-h-screen flex flex-col bg-background">
          ...
          <main className="flex-1 container py-16">
            <div className="max-w-lg mx-auto text-center">
              ...
              <Button onClick={() => { setIsSubmitted(false); setVerifiedPhone(null); setPendingData(null); }}>
                ...
                <Card className="lg:col-span-2">
                  <CardHeader className="p-4 sm:p-6">
                    <CardTitle className="text-lg sm:text-xl">
                      {isAwaitingOTP ? "Verify Your Phone" : "Send Us a Message"}
                    </CardTitle>
                    <CardDescription className="text-sm">
                      {isAwaitingOTP
                        ? "Enter the 6-digit code we just sent you to complete your submission."
                    ...
                    {isAwaitingOTP ? (
                      <div className="space-y-4">
                        ...
                        {isSubmitting && (
                          <div className="flex items-center justify-center gap-2 py-2">
                            ...
                            <span className="text-sm text-muted-foreground">Sending your message…</span>
                          </div>
                        )}
                        <button
                          type="button"
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                        ...
                        <p className="text-xs text-muted-foreground">
                          * Phone verification required to send your message
                        </p>
                      </form>
                    )}
                  </CardContent>
