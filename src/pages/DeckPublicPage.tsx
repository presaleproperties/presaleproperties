...
export default function DeckPublicPage() {
  ...
  return (
    <div className="w-full sm:pb-0 pb-24" style={{ overflowX: "clip" }}>
      ...
      {/* Mobile sticky WhatsApp CTA — slim bar, not overpowering */}
      {deck.contact_whatsapp || deck.contact_phone ? (
        <div
          className="sm:hidden fixed bottom-0 left-0 right-0 z-40 px-4 bg-background/98 border-t border-border/40"
          style={{
        ...
        >
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-2.5 rounded-lg font-semibold text-sm text-white touch-manipulation active:opacity-90 transition-opacity"
