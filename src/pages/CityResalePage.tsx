...
const CITY_CONFIG: Record<string, {
  ...
  "vancouver": {
    ...
    metaTitle: "Vancouver Move-In Ready New Condos 2026 | Under 6 Months",
    metaDescription: "Brand new condos under 6 months old in Vancouver. Downtown, Yaletown, Mount Pleasant. Never lived in, full warranty. Move in within 30-60 days.",
    h1: "Vancouver Move-In Ready New Condos",
    description: "Browse move-in ready new construction in Vancouver. Never lived in condos, townhomes & houses with full warranty. Immediate possession available.",
    neighborhoods: ["Downtown", "Mount Pleasant", "Kitsilano", "East Vancouver", "Yaletown", "Coal Harbour"]
  },
  "surrey": {
    name: "Surrey",
    region: "Fraser Valley",
    metaTitle: "Surrey Move-In Ready New Condos 2026 | Under 6 Months",
    metaDescription: "Brand new condos under 6 months old in Surrey. City Centre, Cloverdale, South Surrey. Never lived in, full warranty. Move in within 30-60 days.",
    h1: "Surrey Move-In Ready New Condos",
    description: "Explore move-in ready new homes in Surrey. Never lived in condos, townhomes across City Centre, Cloverdale, South Surrey & more.",
    neighborhoods: ["City Centre", "Cloverdale", "South Surrey", "Guildford", "Fleetwood", "Clayton Heights"]
  },
  "coquitlam": {
    name: "Coquitlam",
    region: "Tri-Cities",
    metaTitle: "Coquitlam Move-In Ready New Condos 2026 | Near SkyTrain",
    metaDescription: "Brand new condos under 6 months old in Coquitlam. Near Evergreen Line & Burke Mountain. Never lived in, full warranty. Move in within 30-60 days.",
    h1: "Coquitlam Move-In Ready New Condos",
    description: "Find move-in ready new homes in Coquitlam. Never lived in condos near Evergreen Line, Burke Mountain & Coquitlam Centre.",
    neighborhoods: ["Burquitlam", "Burke Mountain", "Coquitlam Centre", "Westwood Plateau", "Austin Heights"]
  },
  "burnaby": {
    name: "Burnaby",
    region: "Metro Vancouver",
    metaTitle: "Burnaby Move-In Ready New Condos 2026 | Metrotown",
    metaDescription: "Brand new condos under 6 months old in Burnaby. Metrotown, Brentwood, Lougheed. Never lived in, full warranty. Move in within 30-60 days.",
    h1: "Burnaby Move-In Ready New Condos",
    description: "Explore move-in ready new homes in Burnaby. Never lived in condos at Metrotown, Brentwood, Lougheed & Edmonds near SkyTrain.",
    neighborhoods: ["Metrotown", "Brentwood", "Lougheed", "Edmonds", "Highgate", "Burnaby Heights"]
  },
  "delta": {
    name: "Delta",
    region: "South of Fraser",
    metaTitle: "Delta Move-In Ready New Condos 2026 | Tsawwassen",
    metaDescription: "Brand new condos under 6 months old in Delta. Tsawwassen, Ladner, North Delta. Never lived in, full warranty. Move in within 30-60 days.",
    h1: "Delta Move-In Ready New Condos",
    description: "Find move-in ready new homes in Delta. Never lived in condos in Tsawwassen, Ladner & North Delta communities.",
    neighborhoods: ["Tsawwassen", "Ladner", "North Delta", "Sunbury"]
  },
  "langley": {
    name: "Langley",
    region: "Fraser Valley",
    metaTitle: "Langley Move-In Ready New Condos 2026 | Willoughby",
    metaDescription: "Brand new condos under 6 months old in Langley. Willoughby, Murrayville, Walnut Grove. Never lived in, full warranty. Move in within 30-60 days.",
    h1: "Langley Move-In Ready New Condos",
    description: "Explore move-in ready new homes in Langley. Never lived in condos in Willoughby, Murrayville, Walnut Grove & more.",
    neighborhoods: ["Willowbrook", "Willoughby", "Murrayville", "Walnut Grove", "Langley City", "Aldergrove"]
  },
  "abbotsford": {
    name: "Abbotsford",
    region: "Fraser Valley",
    metaTitle: "Abbotsford Move-In Ready New Condos 2026 | From $299K",
    metaDescription: "Brand new condos under 6 months old in Abbotsford. Affordable from $299K. Never lived in, full warranty. Move in within 30-60 days.",
    h1: "Abbotsford Move-In Ready New Condos",
    description: "Find move-in ready new homes in Abbotsford. Never lived in condos in West Abbotsford, Clearbrook, Mill Lake & more.",
    neighborhoods: ["West Abbotsford", "Clearbrook", "Mill Lake", "Historic Downtown", "Auguston"]
  },
  "chilliwack": {
    name: "Chilliwack",
    region: "Fraser Valley",
    metaTitle: "Chilliwack Move-In Ready New Condos 2026 | Affordable",
    metaDescription: "Brand new condos under 6 months old in Chilliwack. Affordable new construction. Never lived in, full warranty. Move in within 30-60 days.",
    h1: "Chilliwack Move-In Ready New Condos",
    description: "Explore move-in ready new homes in Chilliwack. Never lived in condos in one of BC's fastest-growing cities.",
    neighborhoods: ["Sardis", "Vedder", "Downtown", "Promontory", "Rosedale"]
  },
  "richmond": {
    name: "Richmond",
    region: "Metro Vancouver",
    metaTitle: "Richmond Move-In Ready New Condos 2026 | Canada Line",
    metaDescription: "Brand new condos under 6 months old in Richmond. Near Canada Line stations. Never lived in, full warranty. Move in within 30-60 days.",
    h1: "Richmond Move-In Ready New Condos",
    description: "Explore move-in ready new homes in Richmond. Never lived in condos in City Centre, Steveston, Brighouse & more.",
    neighborhoods: ["City Centre", "Steveston", "Brighouse", "Ironwood", "West Cambie", "Hamilton"]
  },
  "new-westminster": {
    name: "New Westminster",
    region: "Metro Vancouver",
    metaTitle: "New Westminster Move-In Ready Condos 2026 | SkyTrain",
    metaDescription: "Brand new condos under 6 months old in New Westminster. Near SkyTrain stations. Never lived in, full warranty. Move in within 30-60 days.",
    h1: "New Westminster Move-In Ready New Condos",
    description: "Explore move-in ready new homes in New Westminster. Never lived in condos near SkyTrain in Downtown, Sapperton & Queensborough.",
