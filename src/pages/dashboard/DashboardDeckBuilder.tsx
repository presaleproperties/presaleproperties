...
export default function DashboardDeckBuilder() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (data.contact_name && agents.length > 0) {
        const match = agents.find(a => a.full_name === data.contact_name);
        if (match) setSelectedAgentId(match.user_id);
      }
      setLoading(false);
    })();
  }, [id, isEdit]);
    ...
    <DashboardLayout>
      ...
      <div className="max-w-2xl mx-auto space-y-4 pb-28">
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Internal tool · Presale Properties team
            </p>
          </div>
          {isEdit && slug && (
        ...
        <Section title={`5. Photo Gallery (${gallery.length}/12)`}
          subtitle="First image shown largest — drag to reorder"
        ...
        {/* ── STEP 7: Projections ─────────────────────────────────────── */}
        <Section title="7. Investment Numbers" subtitle="Rental estimates & appreciation rate for the projections section" defaultOpen={false}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 space-y-1.5">
              ...
              <p className="text-xs text-muted-foreground">Used for 5-year chart. Years auto-graduated from this base rate.</p>
            </div>
          </div>
        </Section>
        ...
        <Section title="8. Contact on Deck" subtitle="Team member shown as the agent contact">
          <div className="space-y-4">
            ...
            {agents.length > 0 && (
              <div>
                <p className="text-xs text-muted-foreground mb-2 font-medium uppercase tracking-wider">Quick-select team member</p>
